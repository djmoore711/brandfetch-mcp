...
- BRANDFETCH_CLIENT_ID: API key for logo-by-domain endpoints (high quota) and client ID for hotlinking compliance
- BRANDFETCH_API_KEY: API key for brand details and search endpoints (limited quota)
